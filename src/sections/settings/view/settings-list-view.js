...
// _mock
import { _userList, _roles, USER_STATUS_OPTIONS, _categoryItems, _categoryList } from 'src/_mock';
// hooks
...
const categories = _categoryItems.map((cat) => cat.name);
...
export default function SettingsListView() {
  ...
  const [tableData, setTableData] = useState(_categoryItems);
